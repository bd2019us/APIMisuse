...
{	
	...
	public static List<FilePair> getAllFilesPerSubject(File folder) throws IOException {
		HashMap<String, Integer> CommitChangeLineNumber = getChangeLineNumber("/home/xia/BugDetectionProject/bugdetection/src/main/resources/PythonCode/LineChangeNumber/Results/");
		System.out.println(CommitChangeLineNumber.size());
		...
		for (File version : versions) {
			...
			if(!CommitChangeLineNumber.containsKey(commitNumber)) {
				continue;
			}
